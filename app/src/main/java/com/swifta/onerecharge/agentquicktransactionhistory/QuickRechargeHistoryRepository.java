...
public class QuickRechargeHistoryRepository {
     static List<Row> rowList = new ArrayList<>();

    public QuickRechargeHistoryRepository(List<Row> rows) {
        rowList = rows;
    }
    ...
    public static List<Row> getHistoryListSortedByDate() {
        ...
        Collections.sort(rowList, (o1, o2) -> o2.getEventTime().compareTo(o1.getEventTime()));
