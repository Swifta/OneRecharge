...
public class AgentWalletTopUpPaymentActivity extends AppCompatActivity {
    ...
    String email, referenceId, agentToken, country, otpValue;
    int amount;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreferences = getSharedPreferences(getString(R.string.agent_shared_preference_name)
    ...
    private String getOtpDescription() {
        return sharedPreferences.getString(getResources().getString(R.string
                .saved_agent_wallet_otp_description), "");
    }
    ...
    private void createOtpBackButtonDialog() {
        AlertDialog.Builder alertBuilder = new AlertDialog.Builder
                (AgentWalletTopUpPaymentActivity.this);
    ...
    private void setSavedOtpTransactionValueToFalse() {
        ...
        editor.putBoolean(getResources().getString(R.string.saved_agent_wallet_otp_status), false);
        editor.apply();
    }

    private void returnToDashboard() {
        Intent intent = new Intent(AgentWalletTopUpPaymentActivity.this, AgentActivity.class);
    ...
    private void performWalletTopUp(String description, String transactionId) {
        ...
        AgentWalletTopUpRequest walletTopUpRequest = new AgentWalletTopUpRequest(getWalletAmount(),
                getAgentToken(), description, transactionId, getReferenceId(), getEmail());
    ...
    private String getOtpRef() {
        return sharedPreferences.getString(getResources().getString(R.string
                .saved_agent_wallet_otp_ref), "");
    }

    private void saveCurrentOtpStatus() {
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putBoolean(getResources().getString(R.string.saved_agent_wallet_otp_status),
                true);
        editor.apply();
    }
    ...
    private void saveCurrentOtpValues(String description, String otpRef) {
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putString(getResources().getString(R.string.saved_agent_wallet_otp_description),
                description);
        editor.putString(getResources().getString(R.string.saved_agent_wallet_otp_ref), otpRef);
        editor.apply();
    }

    private void saveWalletTopUpValues() {
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putInt(getResources().getString(R.string.saved_agent_wallet_otp_amount), amount);
        editor.putString(getResources().getString(R.string
                .saved_agent_wallet_otp_customer_token), agentToken);
        editor.putString(getResources().getString(R.string
                .saved_agent_wallet_otp_reference_id), referenceId);
        editor.putString(getResources().getString(R.string.saved_agent_wallet_otp_email), email);
        editor.apply();
    }
    ...
    private Integer getWalletAmount() {
        return sharedPreferences.getInt(getResources().getString(R.string
                .saved_agent_wallet_otp_amount), 0);
    }

    private String getReferenceId() {
        return sharedPreferences.getString(getResources().getString(R.string
                .saved_agent_wallet_otp_reference_id), "");
    }

    private String getAgentToken() {
        return sharedPreferences.getString(getResources().getString(R.string
                .saved_agent_wallet_otp_customer_token), "");
    }

    private String getEmail() {
        return sharedPreferences.getString(getResources().getString(R.string
                .saved_agent_wallet_otp_email), "");
    }
}