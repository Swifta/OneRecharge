package com.swifta.onerecharge.customer.customerregistration;
...
public class CustomerRegistrationActivity extends AppCompatActivity {
    ...
    private void saveCustomerSignUpResult(com.swifta.onerecharge.customer.customerregistration.registerresponsemodel.Data data) {
        SharedPreferences.Editor editor = sharedPreferences.edit();
//        editor.putString(getResources().getString(R.string.saved_customer_auth_token), data
//                .getToken());
